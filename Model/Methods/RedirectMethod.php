...
class RedirectMethod extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public static function getRequestData($config, $storeManager, $methodId, $cardData = null, $entity = null, $moduleDirReader = null)
    {
        ...
        $params = [
            ...
            'MAC'            => $sMAC,
            'url_retour'     => $oEpt->sUrlOK . '?orderId=' . Tools::getIncrementId($entity),
            'url_retour_ok'  => $oEpt->sUrlOK . '?orderId=' . Tools::getIncrementId($entity),
            'url_retour_err' => $oEpt->sUrlKO . '?orderId=' . Tools::getIncrementId($entity),
            'lgue'           => $oEpt->sLangue,
